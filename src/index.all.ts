...
export { TextPathDrawer } from './shape/drawers/TextPathDrawer'
export { TextSvgDrawer } from './shape/drawers/TextSvgDrawer'
...
export { TextPathModel } from './shape/models/TextPathModel'
export { TextSvgModel } from './shape/models/TextSvgModel'
